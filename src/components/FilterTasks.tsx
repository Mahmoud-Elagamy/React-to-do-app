...
const FilterTasks = ({
  ...
  return (
    <section className="flex justify-evenly items-center font-bold bg-white dark:bg-[#25273D] shadow-lg mt-4 p-2 rounded-md text-slate-500 dark:text-slate-400 text-sm md:text-base">
